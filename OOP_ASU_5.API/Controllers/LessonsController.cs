...
namespace OOP_ASU_5.API.Controllers
{
    public class LessonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LessonType,Name,Laboriousness,Notes")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,LessonType,Name,Laboriousness,Notes")] Lesson lesson)
        {
            if (id != lesson.Id)
            {
                return NotFound();
